#' Canadian-level language data collected from the 2016 Canadian Census.
#'
#' `can_lang` lists the counts of how many Canadians report each language as their mother tongue,
...
#'
#' @format A tibble with 178 rows and 6 variables:
#' \describe{
...
#'   \item{language}{Language queried about on the Canadian Census.}
